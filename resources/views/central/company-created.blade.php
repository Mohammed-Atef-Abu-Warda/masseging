...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md text-center max-w-md">
        ...
        <p class="text-gray-600 mb-6">تم إعداد قاعدة البيانات الخاصة بـ <strong>{{ $companyId }}</strong> وإنشاء حساب المدير.</p>
        
        <a href="{{ $loginUrl }}" 
           class="block w-full bg-blue-600 text-white font-bold py-3 px-4 rounded hover:bg-blue-700 transition duration-200">
            الذهاب لتسجيل الدخول في {{ $companyId }}
        </a>
        
        <p class="mt-4 text-sm text-gray-400">الرابط: {{ $loginUrl }}</p>
    </div>
</body>
</html>